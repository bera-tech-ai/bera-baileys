...
import type { BeraBaileysEventEmitter, BeraBaileysEventMap, Contact } from '../Types'
...
export type LidMappingUpdateResult = {
	...
	data: BeraBaileysEventMap['lid-mapping.update']
}
...
export const emitSyncActionResults = (ev: BeraBaileysEventEmitter, results: SyncActionResult[]): void => {
