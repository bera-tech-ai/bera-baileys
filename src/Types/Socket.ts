...
export type SocketConfig = {
	...
	/** should bera-baileys use the mobile api instead of the multi device api
	...
	/** Should BeraBaileys ask the phone for full history, will be received async */
	syncFullHistory: boolean
	/** Should bera-baileys fire init queries automatically, default true */
