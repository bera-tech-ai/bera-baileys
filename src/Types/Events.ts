...
export type BeraBaileysEventMap = {
...
export type BeraBaileysEvent = keyof BeraBaileysEventMap

export interface BeraBaileysEventEmitter {
	on<T extends keyof BeraBaileysEventMap>(event: T, listener: (arg: BeraBaileysEventMap[T]) => void): void
	off<T extends keyof BeraBaileysEventMap>(event: T, listener: (arg: BeraBaileysEventMap[T]) => void): void
	removeAllListeners<T extends keyof BeraBaileysEventMap>(event: T): void
	emit<T extends keyof BeraBaileysEventMap>(event: T, arg: BeraBaileysEventMap[T]): boolean
}
