import type { BeraBaileysEventMap } from '../../Types'
...
describe('event-buffer', () => {
	describe('messaging-history.set pastParticipants buffering', () => {
		it('should include pastParticipants in flushed event', async () => {
			...
			const receivedEvents: BeraBaileysEventMap['messaging-history.set'][] = []
			ev.on('messaging-history.set', (data: BeraBaileysEventMap['messaging-history.set']) => {
